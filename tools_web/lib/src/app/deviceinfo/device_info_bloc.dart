...
class DeviceInfoBloc extends AppBlocBase {
  static const String PATH = 'api/device';
  ...
  String get deviceName => _data['model'] ?? '';

  DeviceInfoBloc(BuildContext context) : super(context);
