...
class DbController {
  ...
  Future<int> executeUpdate(
    ...
    await _ensureOpened();
    return _db!.update(table, values as Map<String, Object?>, where: where, whereArgs: whereArguments);
  }
